                            ...
                            <div className="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
                                ...
                                <form onSubmit={handleSubmit} className="border-t border-gray-200 py-6 px-4 sm:px-6">
                                    <div>
                                        ...
                                        <select data-te-select-init  onClick={setShowModal} onChange={handleSelectChange} className="pointer-events-auto text-sm rounded-lg block p-2.5 bg-blue-500 my-10 mx-8 float-right py-3 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                    <option value="">Pilih meja pelanggan</option>
                    {meja.map((option) => (
                        <option
                            key={option.id_meja}
